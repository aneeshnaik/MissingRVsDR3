...
if __name__ == "__main__":
    ...
    ddir = get_datadir()
    dfile = ddir + "figures/figB1_LAMOST_quantiles_data.npz"
    if not exists(dfile):
    ...
    fig.suptitle("Quantile distributions of LAMOST measurements", x=left + 0.5 * dX)
    ...
    ax1.set_ylabel("Frequency Density [arbitrary units]")
    ...
    # save figure
    plt.savefig("figB1_LAMOST_quantiles.pdf", dpi=800)
