...
if __name__ == "__main__":
    ...
    # load plot data
    ddir = get_datadir()
    dfile = ddir + 'figures/fig4_6D_quantiles_spatial_split_data.npy'
    if not exists(dfile):
    ...
    for row in range(N_rows):
        for col in range(N_cols):
            ...
            if row == 0:
                ...
                ax.text(0.5, 1.45, srow, ha='center', va='bottom')
            if col == N_cols - 1:
                scol = [
                ...
                ax.text(1.05, 0.5, scol, ha='left', va='center')
    ...
    fig.savefig("fig4_6D_quantiles_spatial_split.pdf", dpi=800)
