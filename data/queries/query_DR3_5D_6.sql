...
WHERE (radial_velocity IS NULL) AND (parallax IS NOT NULL) AND (pmra IS NOT NULL) AND (pmdec IS NOT NULL) AND (phot_g_mean_mag IS NOT NULL) AND (phot_g_mean_mag >= 15.8) AND (phot_g_mean_mag < 15.9)
